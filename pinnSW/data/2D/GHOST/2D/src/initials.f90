...
!     cparam0 : ho
!     cparam1 : amplitude of the perturbation
!     cparam2 : length of the perturbation (in 2.pi units)


         DO j = jsta,jend
            DO i = 1,n
               R1(i,j) = cparam0+cparam1*exp(-(2*pi*(real(i,kind=GP)-1)/ real(n,kind=GP)-pi/cparam3 )**2/cparam2**2)
            END DO
         END DO
