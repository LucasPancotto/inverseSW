...
for iit in range(fpm.iit0 + 1, fpm.iitN):
    ...
    if pm.inverse_hb:
        ...
        hb = hb - bpm.lgd * DG
        print('\n lbfgs for inverse hb problem with ', '$- lgd * DG=$', - bpm.lgd * DG.max())
    ...
    if pm.inverse_u0:
        ...
        print('\n lbfgs for inverse u0 problem with ', '$- u0lgd * DJ=$', - bpm.u0lgd * DJ.max())
    ...
    if pm.inverse_h0:
        ...
        print('\n lbfgs for inverse h0 problem with ', '$- h0lgd * DH=$', - bpm.h0lgd * DH.max())
