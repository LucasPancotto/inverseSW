...
plt.close('all')
plt.scatter(grid.xx[::pm.sx], bsolver.hhms_sparse[0,::pm.sx], label='$h_0$', alpha=0.5)
plt.plot(grid.xx, hh0,label='$h_0$ interpolation', color='red')
plt.legend()
plt.savefig(f'{pm.h0_path}/initialh_interp.png')
plt.close('all')
plt.scatter(grid.xx[::pm.sx], true_uu0[::pm.sx], label='$u_0$', alpha = 0.5)
plt.plot(grid.xx, uu0,label=r'$\tilde{u}_0=\sqrt{\frac{g}{h_0}}$', color='red')
plt.legend()
